...
public class CustomAdapter extends ArrayAdapter {
    ...
    int layout_id;
    ArrayList<EmployeeDetail> employeList;

    public CustomAdapter(Context context, int resource, ArrayList<EmployeeDetail> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EmployeeDetail currentVersion = employeList.get(position);
